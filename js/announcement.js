 ...
 */
angular.module('viewCustom').factory('announcement', ['$translate', '$mdToast', '$rootScope', function($translate, $mdToast, $rootScope) {

  return {
    /** 
     *  Displays the announcement if it has not been .
